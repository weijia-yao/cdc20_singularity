...
h = figure; set(gcf,'color','w'); grid on;
th = 0: 0.01: 4*pi;
...
hold on;
plot3(xd(1), yd(1), 0, 'Marker', '.', 'MarkerSize', 30, 'Color', 'red')
plot3(xd(20000), yd(20000), 0, 'Marker', '.', 'MarkerSize', 30, 'Color', 'red')
plot3(xd(300000), yd(300000), 0, 'Marker', '.', 'MarkerSize', 30, 'Color', 'red')
